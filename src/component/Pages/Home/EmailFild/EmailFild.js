...
import img from "../../../../images/photo-1560042387-7fd50f9f7a62.jpeg";
...
const EmailFild = () => {
  const handleFrom = (event) => {
    ...
    fetch("https://car-server-site.vercel.app/feedback", {
      method: "POST",
      headers: {
  ...
  return (
    <div className="my-20">
      <h1 className="text-4xl font-semibold text-center font-serif mb-10">
        Give Your FeedBack
      </h1>
      ...
      >
        ...
        <form onSubmit={handleFrom}>
          ...
          <div className="flex  items-center justify-center mt-4">
            <button className="btn btn-primary bg-gradient-to-r from-primary to-secondary text-white font-mono btn-sm font-bold">
              submit
            </button>
          </div>
        </form>
