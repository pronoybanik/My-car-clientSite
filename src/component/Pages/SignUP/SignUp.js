...
const SignUp = () => {
  const { createUser, updateUser, googleLogin, logOut } =
    ...
    <div className="font-serif h-[600px] flex justify-center items-center">
      <div className="w-96 p-7">
        ...
        <form onSubmit={handleSubmit(handleRegister)}>
          ...
          <div className="form-control ">
            ...
            <input
              ...
              {...register("password", {
                ...
                pattern: {
                  value: /(?=.*[A-Z])(?=.*[!@#$&*])(?=.*[0-9])/,
                  message: "password must have special character and number",
                },
              })}
              className="input input-bordered w-full max-w-xs"
            />
          ...
          <div>{signError && <p className="text-red-600">{signError}</p>}</div>
